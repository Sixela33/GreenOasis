...
const Features = () => {
  return (
    <section class="flex flex-col lg:flex-row px-10 py-5">
      <div class="h-60 w-full lg:w-45%  lg:h-auto relative">
        <Image fill src={officeimg} class="object-cover rounded-lg"/>
      </div>
      <div class="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6 lg:w-1/2">
        <div class="max-w-screen-md mb-8 lg:mb-16">
          <h2 class="mb-4 text-4xl tracking-tight font-bold text-gray-900 dark:text-white">
            Designed for business teams like yours
          </h2>
          <p class="text-gray-500 sm:text-xl dark:text-gray-400">
            Here at Strive we focus on markets where technology, innovation,
